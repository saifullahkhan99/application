...
# print(dir(datetime.datetime.today().time()))
...
TOKEN = 'BzMr0NVG4yAAAAAAAAAAIt6PcATYzZS_sNT7j--aOPCjwXXOV8KZNqKq2bm_bCat'
...
def Call_Backup():
    x = datetime.datetime.today().time().strftime("%H:%M:%S")
    
    LOCALFILE = './Data/database/database.db'
    BACKUPPATH = f'/ghanchi{copy_year}_{copy_month}_{copy_day}_{x}.db'
